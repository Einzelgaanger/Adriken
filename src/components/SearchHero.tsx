...
const SearchHero = () => {
  ...
  return (
    <section className="relative min-h-[88dvh] sm:min-h-[92vh] flex items-center justify-center overflow-hidden">
      {/* Ambient background */}
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-20 sm:pt-24 pb-16 sm:pb-20 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/[0.07] text-primary mb-8 font-medium text-[13px] border border-primary/10"
          >
            <Sparkles className="w-3.5 h-3.5" />
            AI-Powered Matching
          </motion.div>

          <h1 className="font-display text-[2.5rem] sm:text-5xl md:text-6xl lg:text-[4.25rem] font-extrabold leading-[1.08] mb-5 sm:mb-6 text-foreground tracking-tight">
            Just say what you need.
            <br />
            <span className="text-gradient">We'll find who.</span>
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-10 sm:mb-12 max-w-xl mx-auto leading-relaxed font-normal">
            No filters, no browsing. Describe what you're looking for and our AI matches you with the right person nearby.
          </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start p-2.5 sm:p-2 gap-2.5 sm:gap-0">
              <div className="flex-1 flex items-start gap-3 p-2 sm:p-3 min-w-0">
                ...
                <textarea
                  ...
                  className="w-full bg-transparent resize-none border-none outline-none text-foreground placeholder:text-muted-foreground/50 text-[15px] sm:text-base min-h-[44px] sm:min-h-[28px] max-h-[120px] font-body py-1.5 sm:py-0 leading-relaxed"
                  rows={2}
          ...
          >
            {suggestions.map((s) => (
              <button
                ...
                className="px-4 py-2.5 sm:py-2 rounded-full bg-card/80 border border-border/60 text-[13px] text-muted-foreground hover:border-primary/30 hover:text-foreground hover:shadow-soft active:scale-[0.98] transition-all duration-200 min-h-[40px] sm:min-h-0 inline-flex items-center"
              >
                {s}
              </button>
            ))}
