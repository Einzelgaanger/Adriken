...
const ProfileEdit = () => {
  ...
  if (authLoading || isLoading) {
    return (
      <div className="min-h-screen bg-background">
        <Navbar />
        <div className="pt-36 sm:pt-40 flex items-center justify-center min-h-[60vh]">
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-background">
        <Navbar />
        <div className="pt-36 sm:pt-40 pb-16 flex items-center justify-center min-h-[70vh]">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/[0.03] via-background to-background">
      <Navbar />
      <div className="pt-36 sm:pt-40 pb-10 sm:pb-16 px-3 sm:px-6">
